...
@patch('slot_booking.interactors.update_washing_machine_slots_interactor.UpdateWashingMachineSlotsInteractor.check_for_invalid_time_slots')
...
def test_update_slots_interactor_raise_invalid_time_slots(invalid_time_slot_mock):
    ...
    presenter.raise_exception_for_invalid_time_slot.side_effect = \
        BadRequest
    ...
    presenter.raise_exception_for_invalid_time_slot.assert_called_once_with()
