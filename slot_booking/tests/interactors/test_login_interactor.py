...
def test_get_access_token(user, create_user_auth_tokens_mock):
    #Arrange
    username = "username"
    password = "password"
    ...
    storage.is_valid_username_password.return_value = user_obj
    ...
    presenter.get_response_for_login.assert_called_once_with(expected_dto)
