...
from slot_booking.interactors.storages.available_slots_storage_interface import \
    AvailableSlotsStorageInterface

class AvailableSlotsStorageImplementation(AvailableSlotsStorageInterface):
