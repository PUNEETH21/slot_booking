...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Washingmachine',
            fields=[
                ('washing_machine_id', models.CharField(max_length=150, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('washing_machine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='slot_booking.Washingmachine')),
            ],
        ),
        migrations.CreateModel(
            name='UserSlot',
